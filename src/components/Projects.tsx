      ...
      <div className="container mx-auto px-8">
        <div className="flex justify-between items-start mb-16">
          ...
          <div className="max-w-2xl">
            <h3 className="text-white text-3xl font-black uppercase tracking-wide font-fraunces">
        ...
        <div className="space-y-12">
          {projects.map((project, index) => (
            <div 
              ...
              className="grid grid-cols-2 bg-white rounded-2xl overflow-hidden shadow-2xl hover:shadow-[#7FFF00]/20 transition-all duration-300"
              style={{
                opacity: 0,
            ...
            >
              <div className="p-16 flex flex-col justify-between">
                <div className="space-y-8">
                  <h3 className="text-3xl font-black uppercase font-redhat tracking-wide">
                    {project.title}
                  </h3>
